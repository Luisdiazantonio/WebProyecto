...
"[project]/.next-internal/server/app/apilocal/usuarios/[username]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/apilocal/usuarios/[username]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    const nombre = params.nombre; // Aquí debería llegar "Luis Pedro" ya decodificado
    // Verificar que nombre no sea vacío
    if (!nombre) {
    ...
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT * FROM usuarios WHERE nombre = ?', [
            nombre
        ]);
        if (rows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88675087._.js.map